            ...
            <div className="flex bg-[#E5E5E5] pt-5 pb-[35px] font-nunito">
                ...
                <div className="ml-5 mr-[5%] w-full bg-white rounded-lg pl-[50px] pt-[30px] pr-[30px]">
                    <div className="flex flex-col justify-center items-center gap-[30px]">
                        ...
                        <div className="font-bold text-[22px] text-[#4D4B57]">Transfer Success</div>
                    </div>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex justify-end gap-5 mt-10 mb-[30px]">
                            <button className="flex justify-center items-center bg-[#82C3EC] py-4 px-10 rounded-lg gap-4">
                                <div><svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg></div>
                                <div className="text-white">Download PDF</div>
                            </button>

                            <button className="flex justify-center items-center bg-[#FFFFFF] border border-1 border-[#82C3EC] py-4 px-10 rounded-lg gap-4">
                                <div className="text-[#82C3EC]">Back to Home</div>
                            </button>
                        </div>
                    </div>
                </div>
