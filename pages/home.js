    ...
    <div className="flex font-nunito">
        <section className="bg-[#E5E5E5]">
            ...
            <div className="bg-white ml-[20%]">
                ...
                <span className="text-[#82C3EC] text-lg font-bold">Dashboard</span>
                </div>
                ...
                <span className="text-[#3A3D42] opacity-80 text-lg font-bold">Transfer</span>
                </div>

                <div className="flex gap-[23px]">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                <span className="text-[#3A3D42] opacity-80 text-lg font-bold">Top Up</span>
                </div>
                ...
                <span className="text-[#3A3D42] opacity-80 text-lg font-bold">Profile</span>
                </div>

                <div className="flex gap-[23px] pt-[268px]">
                ...
                <span className="text-[#3A3D42] opacity-80 text-lg font-bold">Logout</span>
                </div>
            </div>
        </section>
        <section>Section isi</section>
    </div>
    </>
)
}
